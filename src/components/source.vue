<template>
  ...
  <div>
    ...
    <!-- 目录 -->
    <dir class="m-book-directory" v-if="catalog">
      <h4 class="m-book-title">
        目录<span class="j-cata-length">(共{{ catalog.length }}章)</span
...
.m-book-recent {
  ...
  i {
    ...
    width: 25px;
    height: 15px;
    background: url(https://yuedust.yuedu.126.net/assets/mobile/images/book-detail/icon-recent.png?48ed274f)
      0 0 no-repeat;
    background-size: 100% 100%;
    text-indent: -9999px;
  }
  ...
  .m-book-title {
    ...
    .sort {
      ...
      i {
        ...
        height: 10px;
        display: block;
        background: url(https://yuedust.yuedu.126.net/assets/mobile/images/book-detail/arrow-up.png?12603ac3)
          0 0 no-repeat;
        background-size: 100% 100%;
      }
    }
  ...
  .catalist {
    ...
    .more {
      ...
      i {
        ...
        display: inline-block;
        margin-left: 3px;
        background: url(https://yuedust.yuedu.126.net/assets/mobile/images/book-detail/arrow-right.png?f11cbfe1)
          0 0 no-repeat;
        background-size: 100% 100%;
      }
    }
